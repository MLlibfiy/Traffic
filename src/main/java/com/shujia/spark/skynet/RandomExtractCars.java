	...
	private static JavaPairRDD<String, Row> randomExtractCarInfo(JavaSparkContext sc, final long taskId,JSONObject params, JavaRDD<Row> cameraRDD) {
		...
		JavaPairRDD<String, String> dateHourCar2DetailRDD = cameraRDD.mapToPair(new PairFunction<Row, String,String>() {
			...
			public Tuple2<String, String> call(Row row) throws Exception {
				 ...
				 */
				String key = Constants.FIELD_DATE_HOUR + "=" + dateHour+"|" + Constants.FIELD_CAR + "=" + car;
		...
		//<dateHour,car_count>
		 JavaPairRDD<String, String> dateHour2DetailRDD = dateHourCar2DetailRDD.distinct().mapToPair(new PairFunction<Tuple2<String,String>, String,String>() {
			...
			public Tuple2<String, String> call(Tuple2<String, String> t) throws Exception {
				String dateHour = StringUtils.getFieldFromConcatString(t._1, "\\|", Constants.FIELD_DATE_HOUR);
				return new Tuple2<String, String>(dateHour, t._2);
			}
		});
